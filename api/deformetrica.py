...
from launch.compute_acceleration_flow import compute_acceleration_flow
...
class Deformetrica:
    ...
    def estimate_acceleration_gompertz_regression(self, template_specifications, dataset_specifications,
        ...
        # Instantiate model.
        statistical_model = AccelerationGompertzRegression(template_specifications, **model_options)
        #statistical_model.initialize_noise_variance(dataset)
